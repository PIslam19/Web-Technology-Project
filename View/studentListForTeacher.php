...
?>
    ...
    <head>
        ...
        <title> Student List (Teacher)</title>
    ...
    <body>
        ...
        <div class="row" style="height: 60vh">
            ...
            <div class="col-md-9">
                <?php include "../Controller/Student_CRUD/studentCrudForTeacher_read.php"; ?>

                <h2 class="text-center text-uppercase py-5 fw-bold text-danger">Student List</h2>
