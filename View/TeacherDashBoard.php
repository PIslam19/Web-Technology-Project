    ...
    <body>
        ...
        <div class="row" style="height: 60vh">
            ...
            <div class="col-md-9 mb-5 pb-5">
                <h2 class="fw-bold text-center text-uppercase  mt-5">Teacher Dashboard</h2>
                <div class="row px-5">
                    <div class="col-md-6">
                        <div class="mx-2 p-5 mt-5" style="border-radius: 10px; background: #9dfab6">
                            ...
                            if (isset($_POST["submit"])) {
                                ...
                                if ($photo_size > 5242880) {
                                    ...
                                    $sql = "UPDATE teacher SET userImage='$photo_new_name' WHERE username='$currentUser'";
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <?php
                                $currentUser = $_SESSION["userName"];
                                $sql = "SELECT * FROM teacher WHERE username='$currentUser'";
                                $result = mysqli_query($con, $sql);
                    ...
                    <div class="col-md-6">
                        <div class="mx-2  p-5 mt-5" style="border-radius: 10px; background: #9dfab6">
                            ...
                            ?>
                                        ...
                                        <div>
                                            <a href="teacherProfileChange.php" class="btn btn-success mt-3 btn-sm">Change Password</a>
                                        </div>
                            <?php
                                    }
                                }
