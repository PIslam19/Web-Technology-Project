...
?>
    ...
    <head>
        <title>Student Create (Admin)</title>
    ...
    <body>
            ...
            <div class="col-md-9 p-5">
                <div class="container">
                    <div class="w-75 mx-auto">
                        <h2 class="text-center text-danger fw-bold text-uppercase pb-3">Add Student</h2>
                        <form class="" action="../Controller/Student_CRUD/studentCrudForAdmin_create.php" method="post">
                            ...
                            <a href="studentListForAdmin.php" class="btn btn-danger ms-3 px-4">List</a>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <script src="../Controller/Js_studentValidation/createStudent_JsValidation.js"></script>
    </body>
