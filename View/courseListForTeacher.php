...
?>
    ...
    <head>
        ...
        <title>Course List (Teacher)</title>
    ...
    <body>
        ...
        <div class="row" style="height: 60vh">
            ...
            <div class="col-md-9">
                <?php include "../Controller/Course_CRUD/courseCrudForTeacher_read.php"; ?>

                <h2 class="text-center text-uppercase py-5  text-danger fw-bold" >Available Course</h2>
                ...
                <div class="container">
                    <div class="box">
                        ...
                        <?php } ?>
                        <a href="courseListCreateForTeacher.php" class="btn btn-primary px-4">Add Course</a>
                    </div>
                </div>
            </div>
        </div>
