...
?>
    ...
    <body>
        ...
        <div class="row" style="height: 60vh">
            ...
            <div class="col-md-9">
                <?php include "../Controller/Student_CRUD/studentCrudForAdmin_read.php"; ?>

                <h2 class="text-center fw-bold text-uppercase py-5  text-danger">Student List</h2>
                ...
                <div class="container">
                    <div class="box">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="studentUpdateForAdmin.php?id=<?= $rows['id'] ?>" class="btn btn-success">Update</a>

                                                <a href="../Controller/Student_CRUD/studentCrudForAdmin_delete.php?id=<?= $rows['id'] ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <?php } ?>
                        <a href="studentListCreateForAdmin.php" class="btn btn-primary px-4">Add</a>
                    </div>
                </div>
            </div>
        </div>
