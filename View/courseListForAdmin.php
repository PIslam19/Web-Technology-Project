...
?>
    ...
    <body>
        ...
        <div class="row" style="min-height: 60vh">
            ...
            <div class="col-md-9">
                <?php include "../Controller/Course_CRUD/courseCrudForAdmin_read.php"; ?>

                <h2 class="text-center text-uppercase py-5 fw-bold text-danger">Available Course</h2>
                ...
                <div class="container">
                    <div class="box">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="courseUpdateForAdmin.php?id=<?= $rows['id'] ?>" class="btn btn-success">Update</a>

                                                <a href="../Controller/Course_CRUD/courseCrudForAdmin_delete.php?id=<?= $rows['id'] ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <?php } ?>
                        <a href="courseListCreateForAdmin.php" class="btn btn-primary px-4">Add</a>
                    </div>
                </div>
            </div>
        </div>
